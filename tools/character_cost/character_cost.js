...
(function () {
  ...
  const COPY = {
    ...
    ko: {
      ...
      selectedPlanOver: '{plan} 크레딧의 {percent}%를 사용합니다. 요금제를 높이거나 재생성/버퍼를 줄이세요.',
      customPlan: '맞춤 요금제',
      good: '가능',
      high: '높음',
      over: '초과',
