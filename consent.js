...
(function () {
  ...
  const GA_SCRIPT_ATTR = 'data-voaih-ga';
  ...
  function loadGoogleAnalytics() {
    if (!GA_ID || gaScriptLoaded) return;
    if (document.querySelector('script[' + GA_SCRIPT_ATTR + ']')) {
      gaScriptLoaded = true;
      return;
    }
    ...
    script.setAttribute(GA_SCRIPT_ATTR, 'true');
